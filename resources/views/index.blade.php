...
<body>
        ...
        <nav class="topnavbar navbar-default topnav">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand logo" href="#"><img class="ll" src="{{asset('/image/logo.jpg')}}" alt="Logo Error" /></a>
                </div>
            </div>
        ...
        <div id="carousel-up" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="{{asset('/image/porsche thumbnail.jpg')}}" alt="oldcar" />
                ...
                <div class="item">
                    <img src="{{asset('/image/lamborgini thumbnail.jpg')}}" alt="porche" />
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <img src="{{asset('/image/mercedes thumbnail.jpg')}}" alt="benz" />
                    <div class="carousel-caption">
    ...
    <div class="allcontain">
                ...
                <div class="col-lg-6 costumcol colborder1">
                    <div class="row costumrow">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
                            <img src="{{asset('/image/featurporch.jpg')}}" alt="porsche" />
                        </div>
                ...
                <div class="col-lg-6 costumcol colborder2">
                    <div class="row costumrow">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img2colon">
                            <img src="{{asset('/image/featurporch1.jpg')}}" alt="porsche1" />
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon">
                            <div class="featurecontant">
                                <h1>LOREM IPSUM</h1>
        ...
        <div class="grid">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="txthover">
                        <img src="{{asset('/image/car1.jpg')}}" alt="car1" />
                        <div class="txtcontent">
                            ...
                            <div class="simpletxt">
                                ...
                                <div class="wishtxt">
                                    ...
                                    <p class="paragraph2">
                                        Compare
                                        <span class="icon"><img src="{{asset('/image/compicon.png')}}" alt="compicon" /></span>
                                    </p>
                                </div>
                            </div>
                            <div class="stars2">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="txthover">
                        <img src="{{asset('/image/car2.jpg')}}" alt="car2" />
                        <div class="txtcontent">
                            <div class="stars">
                                <div class="glyphicon glyphicon-star"></div>
                                <div class="glyphicon glyphicon-star"></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="txthover">
                        <img src="{{asset('/image/car3.jpg')}}" alt="car3" />
                        <div class="txtcontent">
                            <div class="stars">
                                <div class="glyphicon glyphicon-star"></div>
                                <div class="glyphicon glyphicon-star"></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="txthover">
                        <img src="{{asset('/image/car4.jpg')}}" alt="car4" />
                        <div class="txtcontent">
                            <div class="stars">
                                <div class="glyphicon glyphicon-star"></div>
                                <div class="glyphicon glyphicon-star"></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="txthover">
                        <img src="{{asset('/image/car5.jpg')}}" alt="car5" />
                        <div class="txtcontent">
                            <div class="stars">
                                <div class="glyphicon glyphicon-star"></div>
                                <div class="glyphicon glyphicon-star"></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="txthover">
                        <img src="{{asset('/image/car6.jpg')}}" alt="car6" />
                        <div class="txtcontent">
                            <div class="stars">
                                <div class="glyphicon glyphicon-star"></div>
                                <div class="glyphicon glyphicon-star"></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="txthover">
                        <img src="{{asset('/image/car7.jpg')}}" alt="car7" />
                        <div class="txtcontent">
                            <div class="stars">
                                <div class="glyphicon glyphicon-star"></div>
                                <div class="glyphicon glyphicon-star"></div>
        ...
        <div class="newslettercontent">
            <div class="leftside">
                <img src="{{asset('/image/border.png')}}" alt="border" />
                <h1>NEWSLETTER</h1>
                <p>
            ...
            <div class="rightside">
                <img class="newsimage" src="{{asset('/image/newsletter.jpg')}}" alt="newsletter" />
        ...
        <div class="bottommenu">
            <div class="bottomlogo">
                <span class="dotlogo">&bullet;</span><img class="ll" src="{{asset('/image/logo.jpg')}}" alt="logo1" /><span class="dotlogo">&bullet;;</span>
            </div>
